...
Any enthusiasts that would still like to use it can now [use it through Github here](https://impieyay.github.io/GW2Power/), host it themselves or simply run it locally (by downloading the entire repository and running `index.html`).
...
1. Update the URL for creating links by changing "https://impieyay.github.io/GW2Power/" to your personal domain in `statcalc.js`
